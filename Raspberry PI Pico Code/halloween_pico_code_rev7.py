...
animatronicsCfg = [['A/Scary Boy',6, 'B/Scary Girl',5,'C/Clown',5,'D/Ghost',5,"sleep time",5],
                    ['E/Crawing Zombie',3, 'DD/Ratman',6,'EE/Leatherface',8,'empty_c2s3',1,"sleep time",1],
                    ['FF/Jump Scare Pumpkin',5,'Skeleton Barrel',5, 'Pumpkin Guy',5,'Witch',5,"sleep time",0],
                    ['Witch]',7, 'Barry',7,'Werewolf 1',5,'Werewolf 2',5,"sleep time",5],
