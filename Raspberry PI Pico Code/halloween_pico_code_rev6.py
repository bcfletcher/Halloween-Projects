...
ControllerIDs=["E661A4D4176D6D29",
               ...
               "E6614104034B2730",
               "E66358986366412B"]
#Controller6_ID="E6614104034B2730"
#Controller7_ID="E66358986366412B"
animatronicsCfg = [['A/Scary Boy',15, 'B/Scary Girl',10,'C/Clown',10,'D/Ghost',10,"sleep time",0],
                    ['E/Crawing Zombie',20, 'DD/Ratman',13,'EE/Leatherface',23,'empty_c2s4',1,"sleep time",0],
                    ['FF/Jump Scare Pumpkin',10,'Skeleton Barrel',10, 'Pumpkin Guy',8,'Witch',8,"sleep time",0],
                    ['Witch]',7, 'Barry',15,'Werewolf 1',5,'Werewolf 2',5,"sleep time",5],
                    ['Ghoul',15, 'Bottomless Zombie',15,'Dog House',10,'Headless Skull Guy',7,"sleep time",5],
                    ['empty_c6s1',10, 'empty_c6s2',10,'empty_c6s3',10,'empty_c6s4',10,"sleep time",5],
                    ['empty_c7s1',10, 'empty_c7s2',10,'empty_c7s3',10,'empty_c7s4',10,"sleep time",5]]
    ...
    while True:
        ...
        if sensorPin.value() == 1:
            ...
            while runAnimatronic == True:
                pass
            set_brightness(green, 100)
            if debug: print("Waiting for sensor detection")
        else:
            pass
